...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// Test helpers for local action execution and cleanup
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
function cleanTestArtifacts(publicDir = TEST_CONFIG.PUBLIC_DIR) {
  const artifactsToRemove = [
    ...
    path.join(publicDir, TEST_CONFIG.ROBOTS_GENERATION.FILENAME),
    path.join(publicDir, TEST_CONFIG.HUMANS_TXT),
  ];
...
function verifySitemapOutput(publicDir = 'dist') {
  const checks = [
    ...
    { file: TEST_CONFIG.ROBOTS_GENERATION.FILENAME, required: true },
    ...
    if (exists) {
      ...
      if (file === 'robots.txt') {
        ...
        if (!content.includes('Sitemap:')) {
          result.valid = false;
          result.errors.push('Missing Sitemap reference');
          allPassed = false;
        }
      }
    } else if (required) {
...
function executeActionWithOverrides(publicDir, overrides = {}, waitMs = 200) {
  ...
  if (!('robots_output_dir' in overrides)) {
    setActionInput('robots_output_dir', publicDir);
  }
  if (!('humans_output_dir' in overrides)) {
